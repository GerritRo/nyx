...
class AtmosphereModel(eqx.Module):
    ...
    def scatter_sources(
        ...
        Returns
        -------
        jax.Array, shape (n_lon, n_lat), or float
        """
        return 0.0
...
class InstrumentModel(eqx.Module):
    ...
    observation axis.  Every concrete instrument provides an ``efficiency``
    Parameter, which the render pipeline multiplies pixel rates by.
    """
