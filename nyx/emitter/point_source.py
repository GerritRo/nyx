...
from nyx.utils.spectra import SpectralModel, StoredSpectrum, blackbody_photon_flux
...
class PointSource(Emitter):
    ...
    spectrum : SpectralModel or array-like, optional
        ...
        wrapped as a :class:`~nyx.utils.spectra.StoredSpectrum`.  Defaults to
    ...
    def _prepare(self, obs: Any) -> SourceObsData:
        ...
        return SourceObsData(
            ...
            per_obs_fields=("source_coords",),
        )

    def _repr_parts(self) -> list[str]:
        icrs = self._coord.icrs
        # Always a Parameter here: this emitter's brightness defaults to 1.0.
